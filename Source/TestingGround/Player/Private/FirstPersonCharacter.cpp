...
void AFirstPersonCharacter::BeginPlay()
{
	...
	if (WeaponBlueprint == NULL) { UE_LOG(LogTemp, Warning, TEXT("Weapon Blueprint missing"));  return; }
	// Spawn weapon
...
void AFirstPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AFirstPersonCharacter::AttemptFire);
...
void AFirstPersonCharacter::AttemptFire()
{
